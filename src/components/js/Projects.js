  ...
  return (
    <section className='App-projects'>
      ...
      <div className='App-projects-examples'>
        ...
        <div className='App-projects-examples-example'>
          <img className='example-img' src={Tenis} alt='tenis' load='lazy' />
          <h2 className='example-h2'>Ping-Pong</h2>
          <a href='https://annaswitaj.github.io/ping-pong/Tenis-1.html'>live</a>
          <a
            className='last'
            href='https://github.com/annaswitaj/ping-pong/blob/master/Tenis-1.html'
          >
            kod
          </a>
        </div>
        <div className='App-projects-examples-example'>
          ...
          <a
            className='last'
            href='https://github.com/annaswitaj/Admin-Dashboard/tree/dev'
          >
            kod
          </a>
        </div>
